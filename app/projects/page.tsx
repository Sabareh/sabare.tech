    ...
    <div className="min-h-screen pt-20 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <AnimatedSection className="mb-16" direction="up">
          ...
          <AnimatedGrid columns={{ default: 1, lg: 2 }} staggerDelay={0.2}>
            {projects
              .filter((p) => p.featured)
              .map((project) => (
                <Card key={project.title} className="glass-effect hover:shadow-xl transition-all duration-300 h-full">
        ...
        <AnimatedSection direction="up">
          ...
          <AnimatedGrid columns={{ default: 1, md: 2, lg: 3 }} staggerDelay={0.1}>
            {projects.map((project) => (
              <Card key={project.title} className="glass-effect hover:shadow-lg transition-all duration-300 h-full">
                <div className="relative overflow-hidden rounded-t-lg">
                  <Image
                    src={project.image || "/placeholder.svg"}
                    alt={project.title}
